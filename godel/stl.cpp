 ...
 *date = *real_date;
 ...
 /*
454 std::cout << "This Prog1 Lightsaber has been modified by <Your Name>" << std::endl
455 << "Copyright (C) 2018 Norbert Bátfai" << std::endl
456 << "License GPLv3+: GNU GPL version 3 or later <http://gnu.org/licenses/gpl.html>" ←-
...
457 */
 ...
 "City/Debrecen/Oktatás/Informatika/Programozás/DEIK/Prog1/Példák/El ̋oadás",
 "City/Debrecen/Szórakozás/Könyv/Ismeretterjeszt ̋o/Informatika",
